...
class CustomerViewTest(TestCase):
    ...
    def test_operator_create(self):
        ...
        пользователем. Возвращает код 403, после получения всех прав - 302
        и перенаправляет на страницу списка клиентов.
        """
    ...
    def test_operator_update(self):
        ...
        пользователем. Возвращает код 403, после получения всех прав - 302
        и перенаправляет на страницу деталей клиентов.
        """
        self.login_operator()
