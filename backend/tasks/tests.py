...
class TaskViewTest(TestCase):
    ...
    def tearDownClass(cls):
        """
        Метод для подтирания медиа файлов после прогона всех тестов.
    ...
    def setUp(self):
        """
        Метод создания данных перед каждым тестом заново. Создает объект
        задачи, так как он может меняться после каждого теста.
        """
