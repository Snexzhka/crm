...
class TaskViewTest(TestCase):
    ...
    def tearDownClass(cls):
        """
        Класс для подтирания медиа файлов после прогона всех тестов. Запускается в конце, после
    ...
    def test_createTask_user(self):
        """
        Тест создания объекта задачи без прав на создание. Возвращает код 302.
        ...
        permission = Permission.objects.get(content_type=content_type, codename='add_task')
