...
def test_view_detail(client, ads):
    """
    Тест проверки невозможности просмотра деталей рекламы неавторизованным
    пользователем. Возвращает код 302 и направляет на страницу входа.
    :param auth_user: fixture
    :param ads: fixture
    :return: 302
    """
...
def test_create_ads(client, product):
    """
    Тест проверки невозможности создания рекламной компании неавторизованным
    пользователем. Возвращает код 302 и направляет на страницу входа.
...
def test_create_by_user(auth_user, product, user):
    ...
    Возвращает код 302, создает рекламную компанию и направляет на страницу списка
    рекламы при наличии определенных разрешений.
    :param client:  fixture
    :param product:  fixture
    :return: 302
    """
...
def test_create_by_admin(auth_admin, product):
    ...
    Возвращает код 302, создает рекламную компанию и направляет на страницу
    списка рекламы.
    :param client:  fixture
    :param product:  fixture
    :return: 302
...
def test_update_advert(client, product, ads):
    """
    Тест проверки невозможности обновления рекламной компании неавторизованным
    пользователем. Возвращает код 302 и направляет на страницу входа.
    :param client:  fixture
    :param ads:  fixture
    :param product:  fixture
...
def test_update_by_user(auth_user, user, product, ads):
    """
    Тест проверки возможности обновления рекламной компании авторизованным
    пользователем. Возвращает код 302, обновляет рекламную компанию и
    направляет на страницу деталей рекламы при наличии определенных разрешений.
    :param client:  fixture
    :param ads:  fixture
    :param product:  fixture
    :return: 302
...
def test_update_by_admin(auth_admin, product, ads):
    ...
    Возвращает код 302, обновляет рекламную компанию и направляет на страницу
    деталей рекламы.
    :param client:  fixture
    :param ads:  fixture
    :param product:  fixture
...
def test_delete_ads(client, ads):
    """
    Тест проверки невозможности удаления рекламной компании неавторизованным
    пользователем. Возвращает код 403.
    :param client:  fixture
    :param ads:  fixture
    :return: 403
    """
...
def test_delete_admin(auth_admin, ads):
    ...
    Возвращает код 302, удаляет рекламную компанию и направляет на страницу
    списка рекламы.
    :param client:  fixture
    :param ads:  fixture
    :return: 302
