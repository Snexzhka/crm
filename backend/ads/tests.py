...
class AdvertTestView(TestCase):
    ...
    def setUpClass(cls):
        """
        Метод установки данных для тестов, отрабатывает один раз перед прогоном
        всех тестов, в самом начале.
        """
    ...
    def setUp(self):
        """
        Метод установки данных для тестов, данные устанавливаются заново перед
        каждым тестом
        """
    ...
    def test_list_view_marketer(self):
        """
        Тест проверки невозможности просмотра списка рекламных компаний
        авторизованным пользователем. Сначала возвращает код 403 (отсутствие
        прав), после наделения правами - код 200.
        """
    ...
    def test_update_marketer(self):
        ...
        пользователем. Сначала, при условии отсутствия прав возвращается код
        403, после наделения ими - 302 с перенаправлением на страницу деталей
        рекламной компании.
        """
        self.login_marketer()
        data = {
